...
def collect_products_from_page(browser):
    ...
    xpath_products = '//*[@id="testId-searchResults-products"]/div[contains(@class, "grid-pod")]/div'
        ...
        for price in prices:
            try:
                ...
                if price.get_attribute("data-cmr-price"):
                    ...
                    precio_internet = text_price
                
            except:
                continue

        dict_data['precio_cmr'] = precio_cmr
        dict_data['precio_internet'] = precio_internet
        dict_data['precio_normal'] = precio_normal
...
for idx, item in enumerate(data, start=1):
    print(f"{idx}. {item['product_link']}\n"
          ...
          f"   precio_internet: {item['precio_internet']}\n"
